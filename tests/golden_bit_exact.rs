...
fn test_pow_table_q13_reference_values() {
    ...
    assert_eq!(POW_TABLE_Q13[3], 35434);
    assert_eq!(POW_TABLE_Q13[4], 52020);
    assert_eq!(POW_TABLE_Q13[128], 5283431);
}
